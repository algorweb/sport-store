...
if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$burger) {
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$burger.addEventListener('click', function () {
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$nav.classList.add('nav--visible');
  });
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$navClose.addEventListener('click', function () {
    _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$nav.classList.remove('nav--visible');
  });
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$nav.addEventListener('click', function (e) {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$colorSelect.addEventListener('click', function (e) {
    if (e.target.parentNode.parentNode.classList.contains('color-select__btn')) {
      document.querySelectorAll('.color-select__btn').forEach(function (el) {
        return el.classList.remove('primary-link--current');
      });
      var alementButton = e.target.parentNode.parentNode;
      var color = alementButton.dataset.color;
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_vars */ "./src/js/_vars.js");
var _require = __webpack_require__(/*! ../_vars */ "./src/js/_vars.js"),
    _vars = _require.default;



if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$cardSliderThumbs) {
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$cardSliderThumbs.addEventListener('click', function (e) {
    if (e.target.classList.contains('card-slider__thumb')) {
      var src = e.target.querySelector('img').dataset.src;
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$sliderImg.setAttribute('src', src);
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$cardSliderItems.forEach(function (el) {
        el.classList.remove('card-slider__thumb--current');
      });
      e.target.classList.add('card-slider__thumb--current');
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$sliderPicture.querySelectorAll('source').forEach(function (el) {
        if (el.getAttribute('type')) {
          var attributeType = el.getAttribute('type');

          if (attributeType.includes('image/avif')) {
            if (src.includes('.jpg') || src.includes('.png')) {
              var indexOfDot = src.indexOf('.');
              var srcPath = src.substring(0, indexOfDot);
              srcPath = srcPath + '.avif';
              el.setAttribute('srcset', srcPath);
            }
          } else if (attributeType.includes('image/webp')) {
            if (src.includes('.jpg') || src.includes('.png')) {
              var _indexOfDot = src.indexOf('.');

              var _srcPath = src.substring(0, _indexOfDot);

              _srcPath = _srcPath + '.webp';
              el.setAttribute('srcset', _srcPath);
            }
          }
        }
      });
...
if (document.querySelector('.page__catalog')) {
  ...
  var createChoiceItem = function createChoiceItem(text) {
    return "\n      <button class=\"btn-reset catalog-choice__item\" data-choice-text=\"".concat(text, "\">\n        ").concat(text, "\n        <svg aria-hidden=\"true\">\n          <use xlink:href=\"img/sprite.svg#close\"></use>\n        </svg>\n      </button>\n    ");
  };
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$catalogFilterItems.forEach(function (el) {
    el.querySelector('input').addEventListener('change', function (e) {
      ...
      if (checked) {
        ...
        var _text = el.querySelector('.custom-checkbox').dataset.text;
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$catalogChoice.addEventListener('click', function (e) {
    ...
    if (e.target.classList.contains('catalog-choice__clear')) {
      Array.from(e.currentTarget.children).forEach(function (el) {
        ...
        document.querySelectorAll('.catalog-filters__quantity').forEach(function (el) {
...
if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$pageCatalog || _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$pageCard) {
  // vars.$headerLogoLink.setAttribute('href', 'index.html');
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$headerLogoLink.href = 'index.html';
}
...
if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$mobileFiltersOpen) {
  ...
  _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$mobileFiltersOpen.addEventListener('click', function (e) {
    if (!openFilters) {
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$mobileFiltersOpen.querySelector('span').textContent = 'Закрыть';
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$catalogFilters.classList.add('catalog-filters--open-btn');
      openFilters = true;
    } else {
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$mobileFiltersOpen.querySelector('span').textContent = 'Фильтры';
      _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$catalogFilters.classList.remove('catalog-filters--open-btn');
      openFilters = false;
    }
  });
}
...
if (_vars__WEBPACK_IMPORTED_MODULE_0__["default"].$stepper) {
  var $stepperInput = _vars__WEBPACK_IMPORTED_MODULE_0__["default"].$stepper.querySelector('.stepper__input'),
  ...
  $stepperInput.addEventListener('keydown', function (e) {
  ...
  $stepperPlus.addEventListener('click', function (e) {
  ...
  $stepperMinus.addEventListener('click', function (e) {
    var currentValue = parseInt($stepperInput.value);
    currentValue--;
    $stepperInput.value = currentValue;
    $stepperPlus.classList.remove('stepper__btn--disabled');
